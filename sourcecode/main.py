...
def meanie_if_copied():
    copied = True
    if copied == True:
        return 'Comeone try not to be a meanie'
    else:
        return 'You are good person. But this case is impossible how you did that'